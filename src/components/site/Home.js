    ...
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          ...
          project and a learning sandbox for you in the months and years to
          come, should you continue to develop software with React. In this
          application we will work through some the basic React concepts, build
          out some small applications, and then unleash you to build your own
          applications.
        </p>
        <hr />
        ...
        <ul>
          ...
          <li>At this phase, this site not yet responsive.</li>
          <li>
